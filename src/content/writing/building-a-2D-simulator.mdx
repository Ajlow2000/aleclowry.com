...
Flash forward to college: I had my first PC capable of playing some games and I finally got the Steam edition of SW:EaW and was able to bask in it's mod support that continues to keep that game alive.
...
In getting this project stood up I implemented a very basic movement system that tracks a units position (x,y coordinates) and accepts a move order to a destination coordinate.
